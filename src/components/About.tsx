          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Your trusted online shopping destination, bringing you the
                finest products with exceptional service and unbeatable prices
                since our inception.
              </p>
            </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    at fair prices, delivered with care and backed by
                    exceptional customer service. Our commitment to excellence
                    has made us a preferred choice for thousands of satisfied
                    customers.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Quick and reliable delivery service to get your orders to you
                  as fast as possible, anywhere in Pakistan.
                </p>
              </div>
              ...
              <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  We're proud to be part of the Vendora community and committed
                  to supporting local growth and development.
                </p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-r from-emerald-600 to-blue-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-emerald-100 max-w-4xl mx-auto leading-relaxed">
              To make quality products accessible to everyone in Pakistan
              through innovative e-commerce solutions, exceptional customer
              service, and a commitment to building lasting relationships with
