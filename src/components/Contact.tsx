        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-colors duration-300">
              ...
              <p className="text-gray-600">
                Once your order is shipped, we'll send you tracking information
                via WhatsApp. You can also contact us directly for real-time
            ...
            <div className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-colors duration-300">
              ...
              <p className="text-gray-600">
                Yes! We offer a 7-day return policy for unused items in original
                packaging. Contact us via WhatsApp to initiate a return or
                exchange.
              </p>
            </div>
